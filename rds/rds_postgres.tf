...
resource "aws_db_instance" "db_instance" {
        ...
        #kms_key_id              = "arn:aws-cn:kms:cn-north-1:256848935116:key/a7ea7c58-0f1c-4f44-96c8-47da99b82016" ##Key for CN Region
        kms_key_id              = "arn:aws:kms:us-west-2:436207872885:key/876ffdf8-d019-47b2-9a18-63e07c1a3f78" ##Key for CN Region
